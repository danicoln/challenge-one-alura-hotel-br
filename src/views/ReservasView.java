...
//        super("Reserva");
	...
	private void salvarReserva() {
		...
		Reserva novaReserva = new Reserva(Date.valueOf(dataEntrada), Date.valueOf(dataSaida), txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
		this.reservaService.salvar(novaReserva);

        JOptionPane.showMessageDialog(null, "O registro: " + novaReserva.getId() + " foi salvo com sucesso!");
